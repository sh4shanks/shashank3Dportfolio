...
const ROOM_META = {
    null: {
        path: '/',
        title: 'Shashank Singh — Creative 3D Portfolio',
        description: 'Interactive 3D portfolio by Shashank Singh. Explore web apps, AI experiments, React projects and creative interactive experiences.',
    },
    about: {
        path: '/about',
        title: 'About Me — Shashank Singh Portfolio',
        description: 'Learn about Shashank Singh — a student developer building modern web apps, AI experiments and interactive digital experiences.',
    },
    gallery: {
        path: '/gallery',
        title: 'Gallery & Projects — Shashank Singh Portfolio',
        description: 'Browse Shashank Singh\'s interactive 3D gallery of web development, AI and creative coding projects.',
    },
    studio: {
        path: '/studio',
        title: 'The Studio — Shashank Singh Portfolio',
        description: 'Explore Shashank\'s project and learning studio — experiments and ideas displayed in an immersive 3D space.',
    },
    contact: {
        path: '/contact',
        title: 'Contact — Shashank Singh Portfolio',
        description: 'Get in touch with Shashank Singh through the interactive 3D contact room.',
    },
};
