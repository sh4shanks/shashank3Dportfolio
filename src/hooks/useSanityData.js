...
const LOCAL_AWARDS = [
  {
    "title": "1st Place \u2014 Infantino Mark 5",
    "year": "2025",
    "organization": "St. Joseph's School",
    "description": "Secured 1st place at Infantino Mark 5 by building a robot car using Arduino Uno."
  },
  {
    "title": "Organizer \u2014 SJS Talentia 2025",
    "year": "2025",
    "organization": "St. Joseph's School",
    "description": "Organized and coordinated SJS Talentia 2025 at St. Joseph's School."
  }
];

export const isSanityConfigured = false; // Personal portfolio uses local content by default.
...
export function useAwards() {
    const [awardsData, setAwardsData] = useState((cache.awards && cache.awards.length ? cache.awards : LOCAL_AWARDS));
