...
const FALLBACK_PROJECTS = [
    {
        id: 'cricketverse', category: 'GAME', title: 'CRICKETVERSE',
        front: '/textures/gallery/shashank_emergency.webp', painted: '/textures/gallery/shashank_emergency_painted.webp',
        url: 'https://github.com/sh4shanks',
        description: 'A cricket-focused interactive game experience built around engaging gameplay, responsive controls and an immersive sports interface.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'codequest', category: 'GAME', title: 'CODEQUEST',
        front: '/textures/gallery/shashank_taskflow.webp', painted: '/textures/gallery/shashank_taskflow_painted.webp',
        url: 'https://github.com/sh4shanks',
        description: 'A coding adventure game concept that turns programming challenges into an interactive quest with levels, logic and problem-solving.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/htmllogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'cybertrace', category: 'GAME', title: 'CYBERTRACE',
        front: '/textures/gallery/shashank_maze.webp', painted: '/textures/gallery/shashank_maze_painted.webp',
        url: 'https://github.com/sh4shanks',
        description: 'A cyber investigation game concept combining clues, interactive exploration and cybersecurity-inspired challenges.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'ios-glass-chess', category: 'WEBSITE', title: 'IOS GLASS CHESS',
        front: '/textures/gallery/shashank_calculator.webp', painted: '/textures/gallery/shashank_calculator_painted.webp',
        url: 'https://github.com/sh4shanks',
        description: 'A premium chess web experience inspired by the liquid-glass visual language of modern Apple interfaces.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'cybershield', category: 'WEBSITE', title: 'CYBERSHIELD',
        front: '/textures/gallery/shashank_emergency.webp', painted: '/textures/gallery/shashank_emergency_painted.webp',
        url: 'https://github.com/sh4shanks',
        description: 'A cybersecurity-focused website concept designed to present digital safety tools, awareness content and security workflows.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'health-monitor', category: 'WEBSITE', title: 'HEALTH MONITOR',
        front: '/textures/gallery/shashank_taskflow.webp', painted: '/textures/gallery/shashank_taskflow_painted.webp',
        url: 'https://github.com/sh4shanks',
        description: 'A responsive health dashboard concept for presenting wellness metrics and monitoring information in a clean interface.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp']
    },
    {
        id: 'sports-commentary', category: 'WEBSITE', title: 'SPORTSCOMMENTARY',
        front: '/textures/gallery/shashank_maze.webp', painted: '/textures/gallery/shashank_maze_painted.webp',
        url: 'https://github.com/sh4shanks',
        description: 'A sports commentary web experience focused on live-style updates, match narratives and an energetic presentation layer.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp']
    },
];

const PROJECT_COUNT = FALLBACK_PROJECTS.length; // Keep the count for the infinite scroll feel
const GAP = 2.5;
