...
// Public portfolio contact destination. FormSubmit delivers visitor messages to this Gmail address.
const CONTACT_EMAIL = 'shashank2009s24@gmail.com';
...
const MessagePaper = ({ position = [0, 0.05, 2], onSend }) => {
    ...
    // Handle send button click - Submit to Shashank's Gmail
    const handleButtonClick = useCallback(async () => {
        ...
        try {
            ...
            if (subjectAnalysis.isSpam || messageAnalysis.isSpam) {
                setErrors({ message: 'Please write a clear subject and message.' });
                setIsSubmitting(false);
                return;
            }

            // --- Send to Shashank's Gmail via FormSubmit ---
    ...
    }, [message, email, subject, botcheck, onSend]);
