...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const handleMailSelect = () => {
        ...
        window.location.href = 'mailto:shashank2009s24@gmail.com';
    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="LINKEDIN"
                onClick={() => window.open('https://github.com/sh4shanks', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="PROJECTS"
                onClick={() => window.open('https://github.com/sh4shanks?tab=repositories', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* INSTAGRAM */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="EMAIL"
                onClick={() => { window.location.href = 'mailto:shashank2009s24@gmail.com'; }}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
