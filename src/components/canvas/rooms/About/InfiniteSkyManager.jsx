...
const IntroMilestone = ({ z, scrollProgressRef }) => {
    // Load avatar texture
    const avatarTexture = useLoader(THREE.TextureLoader, '/textures/corridor/avatar_anim/5.webp');
    ...
    return (
        <group ref={groupRef} position={[0, 0, z]}>
            ...
            <Text
                ...
                fontStyle="italic"
            >
                with code, curiosity and creativity"
            </Text>
        </group>
    );
};
 ...
 */
const AWARDS_DATA = {
    featured: { id: 'build-highlights', layout: 'certificate_grid', title: 'Build Highlights', items: [], platformConfig: { label: 'BUILD', color: '#1a1a1a', icon: '◆' } },
    sotd: { id: 'achievements', layout: 'certificate_grid', title: 'Achievements', items: [], platformConfig: { label: 'ACHIEVEMENT', color: '#1a1a1a', icon: '✦' } },
    sotm: { id: 'milestones', layout: 'certificate_grid', title: 'Milestones', items: [], platformConfig: { label: 'MILESTONE', color: '#1a1a1a', icon: '•' } },
    other: { id: 'other', layout: 'certificate_grid', title: 'Other', items: [], platformConfig: { label: 'OTHER', color: '#1a1a1a', icon: '•' } }
};
