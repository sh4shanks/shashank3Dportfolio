...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'SHASHANK', subtitle: '< student developer />' },
    { id: 'focus', position: [0, 0, -55], type: 'focus', title: 'FOCUS', subtitle: 'Web Apps • AI • Interactive Experiences' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'ISC Class 12 • Building & Learning' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'React • JavaScript • GitHub • UI/UX' },
];
